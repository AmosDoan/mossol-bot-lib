...
import static net.mossol.bot.bot.model.TextType.ADD_MENU_D;
import static net.mossol.bot.bot.model.TextType.ADD_MENU_J;
import static net.mossol.bot.bot.model.TextType.ADD_MENU_K;
import static net.mossol.bot.bot.model.TextType.DEL_MENU_D;
import static net.mossol.bot.bot.model.TextType.DEL_MENU_J;
import static net.mossol.bot.bot.model.TextType.DEL_MENU_K;
import static net.mossol.bot.bot.model.TextType.KEI_CS;
import static net.mossol.bot.bot.model.TextType.LEAVE_ROOM;
import static net.mossol.bot.bot.model.TextType.SELECT_MENU_D;
import static net.mossol.bot.bot.model.TextType.SELECT_MENU_J;
import static net.mossol.bot.bot.model.TextType.SELECT_MENU_K;
import static net.mossol.bot.bot.model.TextType.SHOW_MENU_D;
import static net.mossol.bot.bot.model.TextType.SHOW_MENU_J;
import static net.mossol.bot.bot.model.TextType.SHOW_MENU_K;
import static net.mossol.bot.bot.model.TextType.TEXT;
...
import net.mossol.bot.bot.model.RegexText;
import net.mossol.bot.bot.model.ReplyMessage;
import net.mossol.bot.bot.model.SimpleText;
import net.mossol.bot.bot.service.KeiServiceHandler;
import net.mossol.bot.bot.service.MenuServiceHandler;
import net.mossol.bot.bot.service.MenuServiceHandler.FoodType;
import net.mossol.bot.bot.service.MessageHandler;
